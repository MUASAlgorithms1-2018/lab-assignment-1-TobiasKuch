...
int main () {
    ...
    int mss2 = cubic_mss(arr2, sizeof(arr2)/sizeof(int));
    cout << mss2 << endl;
    mss2 = quadrat_mss(arr2, sizeof(arr2)/sizeof(int));
    cout << mss2 << endl;
    mss2 = linear_mss(arr2, sizeof(arr2)/sizeof(int));
    cout << mss2 << endl;
    ...
    mss = cubic_mss(arr3, sizeof(arr3)/sizeof(int));
    cout << mss << endl;
    mss = quadrat_mss(arr3, sizeof(arr3)/sizeof(int));
    cout << mss << endl;
    mss = linear_mss(arr3, sizeof(arr3)/sizeof(int));
    cout << mss << endl;
    ...
    mss = cubic_mss(arr4, sizeof(arr4)/sizeof(int));
    cout << mss << endl;
    mss = quadrat_mss(arr4, sizeof(arr4)/sizeof(int));
    cout << mss << endl;
    mss = linear_mss(arr4, sizeof(arr4)/sizeof(int));
    cout << mss << endl;
    ...
    mss = cubic_mss(arr5, sizeof(arr5)/sizeof(int));
    cout << mss << endl;
    mss = quadrat_mss(arr5, sizeof(arr5)/sizeof(int));
    cout << mss << endl;
    mss = linear_mss(arr5, sizeof(arr5)/sizeof(int));
    cout << mss << endl;
